...
const db = {
  ...
  updatePatientClinical: async (id, clinicalData) => {
    ...
    patient.clinicalRecord = {
      ...
      urineColor: clinicalData.urineColor || '',
      urineUrgency: clinicalData.urineUrgency || '',
      urineFoaming: clinicalData.urineFoaming || '',
      urineFrequency: clinicalData.urineFrequency || '',
      urinePain: clinicalData.urinePain || '',
      bowelMovement: clinicalData.bowelMovement || '',
